const InterestGroups = [
    ...
    resources: [
      {
        id: "1",
        description:
          "Everything you need to know before getting started as a developer",
  ...
  },
  {
    ...
    officeplace: " @ Discord Lobby",
    thinktankplace: " @ Google Meet",
    thinktanktime: "Saturday 8:30 PM",
    community: ["XtrudAR"],
    leads: [
      {
        id: 1,
    ...
    learningpaths: [
      {
        name: "Unity 3D - Essentials",
        link: "https://learn.unity.com/pathway/unity-essentials",
      },
      {
        name: "Unity 3D - Junior Programmer",
        link: "https://learn.unity.com/pathway/junior-programmer",
      },
      {
        name: "Unity 3D - Creative Core ",
        link: "https://learn.unity.com/pathway/creative-core",
      },

      {
        name: "Blender - Fundementals",
        link: "https://www.youtube.com/playlist?list=PLa1F2ddGya_-UvuAqHAksYnB0qL9yWDO6",
      },
      {
        name: "Blender - Modelling and Sculpting",
        link: "https://www.youtube.com/watch?v=f-mx-Jfx9lA",
      },
      {
        name: "Blender - Python Scripting for Artists",
