        ...
        assignment: [
          {
            ...
            assignment_inner_description:
              "Submit the your assignment link in #ui-ux channel in µLearn Discord server with hashtag #ui-product-design to claim Karma Points",
            example:
        ...
        assignment: [
          {
            ...
            assignment_inner_description:
              "Submit the your design file url in #ui-ux channel in µLearn Discord server with hashtag #ux-intro to claim Karma Points",
            example:
    ...
    sub: [
      {
        ...
        inner_description:
          "After course completion, complete the assignment and post the assignment url in the #ui-ux channel of the µLearn Discord server with the hashtag #ui-figma to avail karma points.",
        assignment: [
          {
            assignment_description:
            ...
            assignment_inner_description:
              "Submit the your assignment link in #ui-ux channel in µLearn Discord server with hashtag #ui-figma to claim Karma Points",
            example:
