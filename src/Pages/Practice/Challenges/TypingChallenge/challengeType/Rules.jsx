...
const Rules = () => {
    ...
    const log = [{
        ...
        "points": ["Each day a person needs to complete 10 levels in the typing challenge", "The lead will mark this in a google sheet and format of the document is provided above", "On providing the link in google sheet here with number of days to the challenge ,you will be provided a leaderboard ", "The leaderboard explained below"]
    },
    {
        "heading": "Toppers",
        "icon": "🔝",
    ...
    },
    {
        ...
        "points": [
            "The disqualified will lose all their points"
        ]
    },
    {
        "heading": "In Spirit",
    ...
    return (
        <div className={styles.mainContainer}>
            ...
            <div className={`${visbile ? "" : "hidden"} p-3`} >
                ...
                <div className='text-[12.5px]'>Rename the 'sheet1' or 'sheet2' to "Typing Challenge" </div>
